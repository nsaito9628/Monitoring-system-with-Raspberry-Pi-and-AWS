...
def input_parameters():
    ...
    return project_name, num_place, place_name, sensor_open_close, S3Bucket, what_num, trigger_select


def config_gen(place_name, S3Bucket, sensor_open_close, what_num, trigger_select):
...
if __name__ == '__main__':
    project_name, num_place, place_name, sensor_open_close, S3Bucket, what_num, trigger_select = input_parameters()
    config_gen(place_name, S3Bucket, sensor_open_close, what_num, trigger_select)
    if what_num == 1:
